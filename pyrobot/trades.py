...
class Trade():
    ...
    def new_trade(self, trade_id:str, order_type:str, side:str, enter_or_exit:str, price:float = 0.00, stop_limit_price: float = 0.00)-> dict:
        ...
        self.order ={
            ...
            "orderLegCollection":[
                {
                    "instruction":self.order_instruction[enter_or_exit][side],
                    "quantity": 0,
                    "instrument":{
                        "symbol": None,
                        "assetType": None
    ...
    def modify_side(self, side: Optional[str], order_leg_id: int = 0)-> None:
        ...
        if side:
            ...
            self.order['orderLegCollection'][order_leg_id]['instructions'] = self.order_instruction[self.enter_or_exit][self.side_opposite]#
    ...
    def add_stop_loss(self, stop_size: float, percentage: bool =False)-> bool:
        ...
        stop_loss_order ={
            ...
            "orderLegCollection":[
                {
                    "instruction": self.order_instruction[self.enter_or_exit_opposite][self.side],
    ...
    def add_stop_limit(self, stop_size:float, limit_size: float, stop_percentage: bool = False, limit_percentage: bool = False)->bool:
        ...
        self.stop_loss_order = stop_limit_order
